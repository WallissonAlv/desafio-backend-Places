package br.com.wallissonalves.placeserviceapi.web;
...
import br.com.wallissonalves.placeserviceapi.domain.PlaceMapper;
...
public class PlaceController {
	...
	public Mono<ResponseEntity<PlaceResponse>> get(@PathVariable("id") Long id) {
		return placeService.get(id).map(place -> ResponseEntity.ok(PlaceMapper.toResponse(place)))
